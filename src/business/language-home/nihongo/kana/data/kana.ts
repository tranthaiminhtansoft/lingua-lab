...
export const choonEntries: readonly SoundMarkEntry[] = [['おばあさん', 'オバーサン', 'obāsan', 'grandmother / elderly woman'], ['おにいさん', 'オニーサン', 'onīsan', 'older brother / young man'], ['くうこう', 'クーコー', 'kūkō', 'airport'], ['', 'ケーキ', 'kēki', 'cake'], ['', 'スーパー', 'sūpā', 'supermarket'], ['', 'コーヒー', 'kōhī', 'coffee']];
